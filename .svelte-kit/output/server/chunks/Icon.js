...
import { G as onDestroy, V as tick, $ as createEventDispatcher, X as rest_props, H as value_or_fallback, F as create_anchor, L as spread_attributes, Y as VoidElements, Q as slot, D as bind_props, E as pop, Z as sanitize_props, z as push, K as spread_props, S as ensure_array_like } from "./main-client.js";
...
function Icon($$payload, $$props) {
  ...
  for (let $$index = 0; $$index < each_array.length; $$index++) {
    ...
    if (tag) {
      const anchor_3 = create_anchor($$payload);
      $$payload.out += `<${tag}${spread_attributes([attrs], false, false, "")}>`;
      if (!VoidElements.has(tag)) {
        $$payload.out += `${anchor_3}`;
...
export {
  ...
  noop as G,
  createBitAttrs as H,
  removeUndefined as I,
  getOptionUpdater as J,
  getPositioningUpdater as K,
  createDispatcher as L,
  disabledAttrs as M,
  cn as N,
  flyAndScale as O,
  Icon as P,
  ...
  endPause as e,
  derivedWithUnsubscribe as f,
  toWritableStores as g,
  generateIds as h,
  isBrowser as i,
  derivedVisible as j,
  builder as k,
